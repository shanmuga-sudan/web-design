        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
          ...
          <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <li><a href="patientProfile.htm"><i class="fa fa-user fa-fw"></i> ${user.firstName} ${user.lastName}</a>
                        </li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <br>
                    <div class="row">
                        <a href="patientProfile.htm"><div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="panel panel-primary text-center no-boder bg-color-brown grow">
                                ...
                                <div class="panel-footer back-footer-red" style="background-color:#ffa64d;color:white;">
                                    
                                    <a href="patientProfile.htm" class="grow" style="color:white;">My Details</a>
                                </div>
                            </div>
                        </div>
                        </a>
                        <a href="#" class="grow" onclick="myFunction();"><div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="panel panel-primary text-center no-boder bg-color-green grow">
                                ...
                                <div class="panel-footer back-footer-green" style="background-color:#00b33c;color:white;">
                        ...
                        <a href="viewBill.htm"> <div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="panel panel-primary text-center no-boder bg-color-blue grow">
                                ...
                                <div class="panel-footer back-footer-blue" style="background-color:#00ace6;color:white;">
                                    My Bill
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="panel panel-primary text-center no-boder bg-color-red grow">
                                ...
                                <div class="panel-footer back-footer-brown" style="background-color:#ff3333;color:white;">
                                    Healtyhy Life
                ...
                <form class="form-horizontal" action='registerEvent.htm'
						method="POST" style="width: 55%; float: left;">

		
						<div class="group" style="margin-bottom:0px;">
							<p><strong>Event Name</strong></p>
							<label></label> <input type="text" name="eventName" value="${events.eventName}" disabled>
						...
						<div class="group" style="margin-bottom:0px;">
							...
							<label></label> <textarea type="text"
								name="details" placeholder="${events.details}" disabled></textarea> <span
								class="highlight"></span> <span class="bar"></span>
						</div>

						<div class="group" style="margin-bottom:0px;">
							<p><strong>Requirements</strong></p>
							<label></label> <textarea type="text" name="requirement" placeholder="${events.requirement}" disabled></textarea>
							<span class="highlight"></span> <span class="bar"></span>
						...
						<div class="group" style="margin-bottom:0px;">
							...
							<label></label> <input type="text"
								name="eventDate" value="${events.date}" disabled> <span class="highlight"></span>
							<span class="bar"></span>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" action = "bookAppointment.htm?action=book" method = "POST">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label class="control-label col-sm-2" for="Doctor">Appointment For:</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
  											...
  											<div class="col-sm-10">
										  	<textarea class="form-control" rows="5" id="reason" name="reason" placeholder = "Enter Reason ..."></textarea>
										  	</div>
										</div>
