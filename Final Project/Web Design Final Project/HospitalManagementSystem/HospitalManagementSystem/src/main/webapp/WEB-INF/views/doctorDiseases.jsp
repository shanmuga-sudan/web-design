        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu" style="font-size:1.4em; padding-left:0.5em">
                    ...
                    <li>
                        <a class="grow" href="doctorHome.htm" ><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="doctorProfile.htm" class="grow"><i class="fa fa-user-md"></i> User Profile</a>
                    </li>
                    <li>
                        <a href="assignedPatient.htm" class="grow"><i class="fa fa-user"></i> Patient</a>
                    </li>
                    <li>
                        <a href="hospitalGallery.htm" class="grow"><i class="fa fa-user"></i> Gallery</a>
                    </li>

                    <li>
                        <a href="doctorDiseases.htm" class="grow"><i class="fa fa-users"></i> Diseases</a>
                    </li>
                                        <li>
