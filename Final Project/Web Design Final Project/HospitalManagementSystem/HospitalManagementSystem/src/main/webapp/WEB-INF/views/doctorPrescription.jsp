...
#doctorPrescription label.error {
	width: auto;
	float: right;
	color: red;
}
...
<script>
	$(function() {
		var availableTags = [ "Abarelix", "Abilify", "Cafcit", "Cefizox",
				"Combiflam", "Aspirin", "Paracetamol", "Naftifine", "Rabavert",
				"Wellbutrin", "Valcyte", "Raloxifene", "Ogen", "Olux",
				"Onsolis", "Haloperidol", "Halcinonide" ];
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu"
					...
					<li><a href="BloodDonor.htm" style="color: black;"
						class="grow"><i class="fa fa-tint"></i>Blood Donor</a></li>
				...
				<div class="row">
					...
					<div>
						<form class="form-horizontal"
							action='doctorPrescriptionSubmit.htm' method="POST"
							id="doctorPrescription" style="width: 45%; float: left;">
							...
							<div class="group" style="margin-bottom: 0px;">
								...
								<label></label> <input type="text" name="tax"
									placeholder="14.6%" disabled> <span class="highlight"></span>
								<span class="bar"></span>
							...
							<div class="group" style="margin-bottom: 0px;">
								...
								<label></label> <input type="text" name="otherCharges" required>
								<span class="highlight"></span> <span class="bar"></span>
							...
							<div class="group" style="margin-bottom: 0px;">
								...
								<label></label> <input type="text" name="discount" required>
								<span class="highlight"></span> <span class="bar"></span>
							...
							<div class="group">
								...
								<label></label> <input type="text" name="price"
									value="${medicine_Price}" required> <span
					...
					<div>
						<form class="form-horizontal" action='doctorMedicines.htm'
							...
							<div class="ui-widget">
								...
								<br> <label for="tags">Tags: </label> <input name="tags"
									id="tags">
							</div>
							</br>
							</br>
