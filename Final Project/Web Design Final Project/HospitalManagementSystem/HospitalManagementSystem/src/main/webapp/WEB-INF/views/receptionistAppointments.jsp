    ...
    <div id="wrapper" >
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Receptionist</a>
            </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <li><a href="receptionistProfile.htm"><i class="fa fa-user fa-fw"></i> ${user.firstName} ${user.lastName}</a>
                        </li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu" style="font-size:1.4em; padding-left:0.5em">
                    ...
                    <li>
                        <a class="grow" href="index.html" ><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="table.html" class="grow"><i class="fa fa-user-md"></i> Doctors</a>
                    </li>
                    <li>
                        <a href="#" class="grow"><i class="fa fa-user"></i> Patients</a>
                    </li>
                    <li>
                        <a href="#" class="grow"><i class="fa fa-user"></i> Appointments</a>
                    </li>

                    <li>
                        <a href="#" class="grow"><i class="fa fa-users"></i> Billing</a>
                    </li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header" style="color:white; margin:0px; padding:0px">
                            Dashboard  
                        </h1>
                    </div>
                </div>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                 <c:forEach items="${rAppointmentList}" var="appointment">
												<tr class="odd gradeX">
                                                    <td>${appointment.appointmentId}</a></td>
                                                    <td>${appointment.appointmentDate}</td>
                                                    <td>Dr. ${appointment.user.firstName}</td>
                                                    <td>${appointment.user1.firstName}</td>
