		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu"
					...
					<li><a href="adminPatients.htm" class="grow" style="color: black;"><i
					...
					<div class="row" id="appointmentTable">
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">Receptionists</div>
								<div class="panel-body">
										...
										<table class="table table-striped table-bordered table-hover"
											...
											<tbody>
												<c:forEach items="${receptionistList}" var="receptionist">
													<tr class="odd gradeX">
														<td>${receptionist.firstName}</a></td>
														<td>${receptionist.lastName}</td>
														<td>${receptionist.emailId}</td>
														<td>${receptionist.mobileNUmber}</td>
