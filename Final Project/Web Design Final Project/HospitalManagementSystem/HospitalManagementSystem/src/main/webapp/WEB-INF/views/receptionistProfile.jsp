		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu"
					...
					<li><a class="grow" href="recptionistHome.htm" style="color: black;"><i
							class="fa fa-dashboard"></i> Dashboard</a></li>
					<li><a href="receptionistAllDoctor.htm" class="grow"
						style="color: black;"><i class="fa fa-user-md"></i> Doctors</a></li>
					<li><a href="receptionistAllPatient.htm" class="grow"
						style="color: black;"><i class="fa fa-user"></i> Patients</a></li>
					<li><a href="receptionistAppointments.htm" class="grow"
						style="color: black;"><i class="fa fa-user"></i> Appointments</a>
					</li>

					<li><a href="#" class="grow" style="color: black;"><i
							class="fa fa-users"></i> Billing</a></li>
